...
def mathlibProofObligation : MathlibProofObligation := {
  ...
  carriedGap := "Wireless endgame pilot closes over the admitted class; unrestricted classical closure remains carried"
}
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedWirelessClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_wireless_endgame A
